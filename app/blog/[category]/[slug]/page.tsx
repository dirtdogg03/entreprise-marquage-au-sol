    ...
    <>
      ...
      <section className="relative py-16 lg:py-24 bg-hero-pattern">
        <div className="relative mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <span className="inline-flex items-center rounded-full bg-primary-500 px-4 py-1.5 text-sm font-medium text-secondary-900 mb-6">
            {category.name}
          </span>
      ...
      <section className="py-12 lg:py-16 bg-secondary-950">
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          <article className="prose prose-lg prose-invert max-w-none
            ...
            prose-h3:text-xl prose-h3:font-semibold prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-white
            prose-p:text-secondary-300 prose-p:leading-relaxed prose-p:mb-4
            prose-strong:text-white prose-strong:font-semibold
            prose-ul:text-secondary-300 prose-ul:my-4
            prose-ol:text-secondary-300 prose-ol:my-4
            prose-li:my-1 prose-li:marker:text-primary-500
            prose-table:text-sm prose-table:my-6
            prose-thead:bg-secondary-800
            prose-th:text-white prose-th:font-semibold prose-th:px-4 prose-th:py-3 prose-th:text-left
            prose-td:px-4 prose-td:py-3 prose-td:border-secondary-700
            prose-tr:border-b prose-tr:border-secondary-700
            prose-a:text-primary-400 prose-a:font-medium prose-a:no-underline hover:prose-a:underline
            prose-blockquote:border-l-primary-500 prose-blockquote:bg-secondary-800 prose-blockquote:py-1 prose-blockquote:px-4 prose-blockquote:italic prose-blockquote:text-secondary-300
            prose-code:text-primary-400 prose-code:bg-secondary-800 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm
