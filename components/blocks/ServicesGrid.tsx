      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Nos <span className="text-primary-500">Services</span> de Marquage
          </h2>
        ...
        {!showAll && filteredServices.length > maxItems && (
          ...
          >
            <Link
              href="/services"
              className="inline-flex items-center gap-2 rounded-xl bg-secondary-800 px-6 py-3 text-base font-semibold text-white hover:bg-secondary-700 transition-colors ring-1 ring-secondary-700"
            >
  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative flex flex-col h-full rounded-2xl bg-secondary-900/50 p-6 ring-1 ring-secondary-800 hover:ring-primary-500/50 transition-all duration-300 hover:bg-secondary-900"
      >
        {/* Icon */}
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {service.benefits.slice(0, 2).map((benefit) => (
            <span
              key={benefit}
              className="inline-flex items-center rounded-full bg-secondary-800 px-2.5 py-0.5 text-xs text-secondary-300"
            >
              {benefit}
            </span>
          ))}
