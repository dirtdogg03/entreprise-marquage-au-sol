...
export default function CTABanner({
  ...
  return (
    <section className="relative section-padding overflow-hidden bg-primary-600">
      {/* Subtle pattern */}
        ...
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary-700/50 text-lg font-semibold text-white hover:bg-primary-700 transition-all duration-200 ring-1 ring-white/20"
            >
